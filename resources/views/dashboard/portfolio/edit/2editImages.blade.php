                    ...
                    <div class="card-body">
                        <div class="row">
                            @foreach ($project_images as $img)
                                <div class="col-md-3">
                                    ...
                                    <br>
                                    {!! Form::open(['action' => ['DashboardController@deleteImage', $project_id], 'method' => 'post']) !!}
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                {!! Form::open(['action' => ['DashboardController@updateProject', $project_id], 'files' => true, 'method' => 'put', 'enctype' => 'multipart/form-data', 'id' => 'form1']) !!}
